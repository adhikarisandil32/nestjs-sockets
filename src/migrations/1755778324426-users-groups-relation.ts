...
export class UsersGroupsRelation1755778324426 implements MigrationInterface {
    name = 'UsersGroupsRelation1755778324426'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "groups_users" ADD CONSTRAINT "FK_7fff02b7fb30cd3730d90693dec" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
